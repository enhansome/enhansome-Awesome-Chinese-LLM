...
* ChatGLM3-6B
  * 地址：<https://github.com/THUDM/ChatGLM3> ⭐ 13,655 | 🐛 35 | 🌐 Python | 📅 2025-01-13
...
* Chinese-LLaMA-Alpaca：
  * 地址：<https://github.com/ymcui/Chinese-LLaMA-Alpaca> ⭐ 18,931 | 🐛 5 | 🌐 Python | 📅 2026-04-19
...
* Llama2-Chinese：
  * 地址：<https://github.com/FlagAlpha/Llama2-Chinese> ⭐ 14,738 | 🐛 195 | 🌐 Python | 📅 2025-04-06
...
* Moss：
  * 地址：<https://github.com/OpenLMLab/MOSS> ⭐ 12,230 | 🐛 242 | 🌐 Python | 📅 2026-05-27
...
* MiniCPM
  * 地址：<https://github.com/OpenBMB/MiniCPM> ⭐ 10,250 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-07-27
...
* MiniCPM-V
  ...
  * 地址：<https://github.com/OpenBMB/MiniCPM-V> ⭐ 26,240 | 🐛 59 | 🌐 Python | 📅 2026-08-26
...
* MedicalGPT
  ...
  * 地址：<https://github.com/shibing624/MedicalGPT> ⭐ 5,748 | 🐛 6 | 🌐 Python | 📅 2026-06-03
...
* Lawyer LLaMA：中文法律LLaMA
  ...
  * 地址：<https://github.com/AndrewZhe/lawyer-llama> ⭐ 1,000 | 🐛 35 | 🌐 Python | 📅 2024-08-28
...
* ChatLaw-法律大模型
  ...
  * 地址：<https://github.com/PKU-YuanGroup/ChatLaw> ⭐ 7,588 | 🐛 65 | 📅 2025-01-04
...
* FinGPT
  ...
  * 地址：<https://github.com/AI4Finance-Foundation/FinGPT> ⭐ 21,153 | 🐛 86 | 🌐 Jupyter Notebook | 📅 2026-08-02
...
* EduChat：
  ...
  * 地址：<https://github.com/icalk-nlp/EduChat> ⭐ 966 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-07-18
...
* 稷丰（AgriAgent）：
  * 简介：首个开源中文农业多模态大模型是由山西农业大学研发，以[MiniCPM-Llama3-V 2.5](https://github.com/OpenBMB/MiniCPM-V) ⭐ 26,240 | 🐛 59 | 🌐 Python | 📅 2026-08-26为底座，能够从图像、文本、气象数据等多源信息中提取有用信息，为农业生产提供全面、精准的智能化解决方案。我们致力于将稷丰应用于作物健康监测、病虫害识别、土壤肥力分析、农田管理优化等多个方面，帮助农民提升生产效率，减少资源浪费，促进农业的可持续发展。
...
* langchain-ChatGLM：
  ...
  * 地址：<https://github.com/imClumsyPanda/langchain-ChatGLM> ⭐ 38,581 | 🐛 25 | 🌐 Python | 📅 2025-11-10
...
* ChatDev：
  ...
  * 地址：<https://github.com/OpenBMB/ChatDev> ⭐ 34,126 | 🐛 68 | 🌐 Python | 📅 2026-07-24
...
* fastllm：
  ...
  * 地址：<https://github.com/ztxz16/fastllm> ⭐ 4,945 | 🐛 312 | 🌐 C++ | 📅 2026-08-26
...
* GPT Academic：
  ...
  * 地址：<https://github.com/binary-husky/gpt_academic> ⭐ 71,245 | 🐛 330 | 🌐 Python | 📅 2026-01-25
...
* ChatALL：
  ...
  * 地址：<https://github.com/sunner/ChatALL> ⭐ 16,483 | 🐛 228 | 🌐 JavaScript | 📅 2026-08-19
...
* LazyLLM
  ...
  * 地址：<https://github.com/LazyAGI/LazyLLM> ⭐ 3,876 | 🐛 49 | 🌐 Python | 📅 2026-08-26
...
* MNBVC
  ...
  * 地址：<https://github.com/esbatmop/MNBVC> ⭐ 4,267 | 🐛 22 | 📅 2026-08-15
...
* Chinese medical dialogue data：
  ...
  * 地址：<https://github.com/Toyhom/Chinese-medical-dialogue-data> ⭐ 1,756 | 🐛 6 | 🌐 Python | 📅 2023-08-18
...
* DeepSpeed Chat：
  ...
  * 地址：<https://github.com/microsoft/DeepSpeed/tree/master/blogs/deepspeed-chat> ⭐ 43,003 | 🐛 1,324 | 🌐 Python | 📅 2026-08-26
...
* LLaMA Efficient Tuning：
  ...
  * 地址：<https://github.com/hiyouga/LLaMA-Efficient-Tuning> ⭐ 74,382 | 🐛 1,137 | 🌐 Python | 📅 2026-08-26
...
* vLLM：
  ...
  * 地址：<https://github.com/vllm-project/vllm> ⭐ 90,145 | 🐛 7,068 | 🌐 Python | 📅 2026-08-26
...
* CTranslate2
  ...
  * 地址：<https://github.com/OpenNMT/CTranslate2> ⭐ 4,644 | 🐛 279 | 🌐 C++ | 📅 2026-08-16
...
* OpenLLM
  ...
  * 地址：<https://github.com/bentoml/OpenLLM> ⭐ 12,518 | 🐛 16 | 🌐 Python | 📅 2026-08-24
...
* MNN LLM
  ...
  * 地址：<https://github.com/alibaba/MNN> ⭐ 15,972 | 🐛 36 | 🌐 C++ | 📅 2026-08-25
...
* MLC LLM
  ...
  * 地址：<https://github.com/mlc-ai/mlc-llm> ⭐ 23,095 | 🐛 336 | 🌐 Python | 📅 2026-08-17
    ![](https://img.shields.io/github/stars/mlc-ai/mlc-llm.svg)
  * 简介：支持不同平台上的不同设备部署推理，包括移动设备（iOS或Android设备等）的高效推理，压缩等。但对大规模批量调用相对不友好。

* LightLLM：

  * 地址：<https://github.com/ModelTC/lightllm> ⭐ 4,244 | 🐛 156 | 🌐 Python | 📅 2026-08-26
...
* LMDeploy:
  ...
  * 地址：<https://github.com/InternLM/lmdeploy> ⭐ 8,024 | 🐛 596 | 🌐 Python | 📅 2026-08-26
...
* OpenCompass:
  ...
  * 地址：<https://github.com/InternLM/opencompass> ⭐ 7,365 | 🐛 382 | 🌐 Python | 📅 2026-08-26
...
* chinese-llm-benchmark：
  ...
  * 地址：<https://github.com/jeinlee1991/chinese-llm-benchmark> ⭐ 6,401 | 🐛 18 | 📅 2026-08-23
...
* LLMsPracticalGuide：
  ...
  * 地址：<https://github.com/Mooler0410/LLMsPracticalGuide> ⭐ 10,200 | 🐛 17 | 📅 2026-04-08
...
* 面向开发者的 LLM 入门课程：
  ...
  * 地址：<https://github.com/datawhalechina/prompt-engineering-for-developers> ⭐ 24,590 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2025-06-12
...
* awesome-chatgpt-prompts-zh：
  ...
  * 地址：<https://github.com/PlexPt/awesome-chatgpt-prompts-zh> ⭐ 61,834 | 🐛 46 | 📅 2026-04-28
...
* OpenAI Cookbook：
  ...
  * 地址：<https://github.com/openai/openai-cookbook> ⭐ 75,570 | 🐛 295 | 🌐 Jupyter Notebook | 📅 2026-08-26
...
* llm-action：
  ...
  * 地址：<https://github.com/liguodongiot/llm-action> ⭐ 24,958 | 🐛 20 | 🌐 HTML | 📅 2026-07-19
...
* Awesome-AITools：
  ...
  * 地址：<https://github.com/ikaijua/Awesome-AITools> ⭐ 6,151 | 🐛 42 | 🌐 Python | 📅 2026-08-26
...
* Awesome-LLM：
  ...
  * 地址：<https://github.com/Hannibal046/Awesome-LLM> ⭐ 27,287 | 🐛 445 | 📅 2025-07-31
...
* LLMs-In-China：
  ...
  * 地址：<https://github.com/wgwang/LLMs-In-China> ⭐ 6,471 | 🐛 19 | 📅 2024-11-30
...
* awesome-free-chatgpt：
  ...
  * 地址：<https://github.com/LiLittleCat/awesome-free-chatgpt> ⭐ 21,230 | 🐛 121 | 🌐 Python | 📅 2025-06-23
...
* Awesome AI Startups：
  ...
  * 地址：<https://github.com/nowork-studio/awesome-ai-startups> ⭐ 77 | 🐛 35 | 📅 2026-08-26
